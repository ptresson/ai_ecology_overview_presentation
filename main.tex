...
%%% compress with
%% gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/prepress -dNOPAUSE -dQUIET -dBATCH -sOutputFile=main_compress.pdf main.pdf
...
\begin{frame}
    ...
    \begin{figure}
        \begin{center}
    \includegraphics[width=.5\textwidth]{./figs/safonova.png}
...
\begin{frame}
    \centering
    \includegraphics<1>[width=.5\linewidth]{./figs/schemas/good_fit_test.png}%
    \includegraphics<2>[width=.5\linewidth]{./figs/schemas/shift1.png}%
    \includegraphics<3>[width=.5\linewidth]{./figs/schemas/shift2.png}%
\end{frame}
